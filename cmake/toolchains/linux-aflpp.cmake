...
# Reassert the Bootlin sysroot after replacing only the compiler drivers.
# CMake may invalidate cache entries while it redetects a changed compiler.
set(CMAKE_SYSROOT "${PSLOG_BOOTLIN_SYSROOT}" CACHE PATH "" FORCE)
set(CMAKE_FIND_ROOT_PATH "${PSLOG_BOOTLIN_SYSROOT}" "${PSLOG_BOOTLIN_ROOT}" CACHE STRING "" FORCE)
