...
/*
#cgo CFLAGS: -O3 -DNDEBUG -I${SRCDIR}/../../build/lua-sdk/include -I${SRCDIR}/../../build/lua-host/include
#cgo LDFLAGS: ${SRCDIR}/../../build/lua-sdk/lib/libpslog.a ${SRCDIR}/../../build/lua-host/lib/liblua.a -lm -ldl -pthread
