...
if(NOT host_toolchain MATCHES "CMAKE_HOST_SYSTEM_NAME STREQUAL \"Linux\"" OR
   NOT host_toolchain MATCHES "CMAKE_HOST_SYSTEM_NAME STREQUAL \"Darwin\"" OR
   NOT host_toolchain MATCHES "PSLOG_ALLOW_HOST_COMPILER" OR
   NOT host_toolchain MATCHES "CMAKE_TRY_COMPILE_PLATFORM_VARIABLES")
    message(FATAL_ERROR "host toolchain must require Bootlin by default and expose the developer host compiler override")
endif()
