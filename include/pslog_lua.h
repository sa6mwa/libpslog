 ...
 * alive and only on the owning `lua_State`.
 */
 ...
 * reference and is destroyed by `pslog_lua_unref_logger()`.
 */
 ...
 * does not raise Lua errors for ordinary validation failures.
 */
